...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IdeaBox = __webpack_require__(159);

	(0, _reactDom.render)(_react2['default'].createElement(_IdeaBox.IdeaBox, { title: 'IdeaBox' }), document.getElementById('react-root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IdeaForm = __webpack_require__(160);

	var _Ideas = __webpack_require__(161);

	var IdeaBox = (function (_Component) {
	  _inherits(IdeaBox, _Component);

	  function IdeaBox() {
	    _classCallCheck(this, IdeaBox);

	    _get(Object.getPrototypeOf(IdeaBox.prototype), 'constructor', this).call(this);
	    this.getIdeas();
	    this.state = {
	      ideas: []
	    };
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'row' },
	          _react2['default'].createElement(_IdeaForm.IdeaForm, null),
	          _react2['default'].createElement(_Ideas.Ideas, { ideas: this.state.ideas })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function IdeaForm() {
	  return _react2["default"].createElement(
	    "div",
	    { className: "idea-forms col-xs-11 col-sm-5" },
	    _react2["default"].createElement(
	      "div",
	      ...
	      _react2["default"].createElement(
	        "form",
	        { id: "ajax-create-idea" },
	        _react2["default"].createElement("input", { type: "text", name: "title", id: "title", placeholder: "idea title", className: "form-control idea-title", required: true, maxLength: "35" }),
	        _react2["default"].createElement("textarea", { name: "body", id: "body", placeholder: "idea body", className: "form-control idea-body", required: true, maxLength: "100" }),
	        _react2["default"].createElement("input", { type: "submit", name: "commit", value: "save", className: "btn btn-primary idea-button" })
	      ),
	      _react2["default"].createElement("br", null),
	      _react2["default"].createElement("input", { type: "text", name: "idea-search", id: "idea-search", placeholder: "search ideas", className: "form-control idea-title" }),
	      _react2["default"].createElement("br", null),
	      _react2["default"].createElement(
	        "button",
	        { type: "button", name: "commit", value: "all", className: "btn btn-primary idea-button filter-button active-filter" },
	        "all"
	      ),
	      _react2["default"].createElement(
	        "button",
	        { type: "button", name: "commit", value: "maybe", className: "btn btn-primary idea-button filter-button" },
	        "maybe"
	      ),
	      _react2["default"].createElement(
	        "button",
	        { type: "button", name: "commit", value: "yes", className: "btn btn-primary idea-button filter-button" },
	        "yes"
	      ),
	      _react2["default"].createElement(
	        "button",
	        { type: "button", name: "commit", value: "now", className: "btn btn-primary idea-button filter-button" },
	        "now"
	      )
	    )
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _idea = __webpack_require__(162);
	...
	function Ideas(_ref) {
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: 'ideas col-xs-12 col-sm-7' },
	    ideas.map(function (idea) {
	      return _react2['default'].createElement(_idea.Idea, { idea: idea, key: idea._id.$oid });
	    })
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Idea(_ref) {
	  ...
	  return _react2["default"].createElement(
	    "div",
	    { id: idea._id.$oid, className: "idea", "data-quality": idea.quality },
	    _react2["default"].createElement(
	      "div",
	      { className: "row idea-header" },
	      _react2["default"].createElement(
	        "div",
	        { className: "col-xs-12" },
	        _react2["default"].createElement(
	          "span",
	          { className: "delete-idea pointer" },
	          "x"
	        ),
	        _react2["default"].createElement(
	          "div",
	          ...
	          _react2["default"].createElement(
	            "div",
	            { className: "col-xs-12 upvote-div" },
	            _react2["default"].createElement(
	              "div",
	              { className: "upvote pointer" },
	              "+"
	            )
	          )
	        ),
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "div",
	            { className: "col-xs-12 downvote-div" },
	            _react2["default"].createElement(
	              "div",
	              { className: "downvote pointer" },
	              "-"
	            )
	          )
	        ),
